...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ymro8gy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ymro8gy.containers.anotherwebservice.com/
...
```
git clone git@github.com:plsgivemeachane/container-ymro8gy.git
cd container-ymro8gy
```
...
```
docker attach container-ymro8gy
```
